export function PricingEligibilityPage() {
  return (
    <div className="min-h-screen pt-24" style={{ backgroundColor: '#F9F8F5' }}>
      <div className="mx-auto max-w-[1200px] px-6 md:px-12 py-20 md:py-28">
        {/* Header */}
        <div className="mb-16">
          <h1 className="text-[2.5rem] md:text-[3.5rem] leading-[1.2] tracking-[-0.015em] mb-6" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 400, color: '#0D1F3C' }}>
        ...
        {/* Pricing Section */}
        <div className="mb-20">
          <h2 className="text-[2rem] md:text-[2.5rem] leading-[1.2] tracking-[-0.015em] mb-8" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 400, color: '#0D1F3C' }}>
            Membership Fees
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            ...
            <div className="p-8" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E8E5E0' }}>
              <div className="mb-4">
                ...
                <p className="text-[2.5rem] leading-[1.2] tracking-[-0.02em]" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 500, color: '#0D1F3C' }}>
                  €1,000
                </p>
              ...
              <div className="px-4 py-3 mb-4" style={{ backgroundColor: '#F9F8F5', border: '1px solid #E8E5E0' }}>
          ...
          <div className="p-10" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E8E5E0' }}>
            <h3 className="text-[1.5rem] tracking-[-0.01em] mb-6" style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 500, color: '#0D1F3C' }}>
